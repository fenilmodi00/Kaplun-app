...
CSV_CONFIG = {
    ...
    "nativewind": {
        "file": "nativewind.csv",
        "search_cols": ["Category", "Topic", "Keywords", "Description", "Do", "Don't", "Notes"],
        "output_cols": ["Category", "Topic", "Keywords", "Description", "Do", "Don't", "Code Example", "Notes", "Docs URL"]
    },
    "expo": {
        "file": "expo.csv",
        "search_cols": ["Category", "Topic", "Keywords", "Description", "Do", "Don't", "Notes"],
...
def _domain_keywords():
    ...
    _DOMAIN_KEYWORDS = {
        ...
        "typography": ["font pairing", "typography pairing", "heading font", "body font", "font family", "font weight", "font style", "variable font", "font", "typography", "serif", "sans"],
        ...
        "nativewind": ["nativewind", "className", "cssInterop", "remapProps", "platform variant", "ios:", "android:", "web:", "native:", "dark mode", "colorScheme", "vars", "safe-area-inset", "withNativeWind", "metro", "tailwind v4", "@theme", "pseudo class", "active:", "hover:", "focus:", "disabled:", "group", "flex", "dp", "px", "calc", "platformColor"],
        "expo": ["expo", "expo-router", "Stack", "Tabs", "Link", "useLocalSearchParams", "useRouter", "useFocusEffect", "usePathname", "Stack.Screen", "app.json", "expo-font", "expo-secure-store", "expo-image", "expo-blur", "expo-linear-gradient", "expo-status-bar", "expo-splash-screen", "development build", "eas", "sdk 57", "metro config", "environment variables", "EXPO_PUBLIC"]
    }
    return _DOMAIN_KEYWORDS
...
_DOMAIN_TIEBREAK_ORDER = [
    ...
    "chart", "icons", "gsap", "react", "web", "nativewind", "expo",
]
